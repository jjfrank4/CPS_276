...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'jfranklin4';//this will be your WCC username
      $dbUsr = 'jfranklin4';//this will be your WCC username
      $dbPass = '3wzi8magfBteWkY';//this will be the password found in the video.
